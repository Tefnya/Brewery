...
public class TabRegistry {
    ...
    public static final RegistrySupplier<CreativeModeTab> BREWERY_TAB = CREATIVE_MODE_TABS.register("brewery", () -> CreativeModeTab.builder(CreativeModeTab.Row.TOP, 1)
            ...
            .displayItems((parameters, out) -> {
                ...
                out.accept(ObjectRegistry.BARLEY_SEEDS.get());
                out.accept(ObjectRegistry.BARLEY.get());
                out.accept(ObjectRegistry.CORN_SEEDS.get());
                out.accept(ObjectRegistry.CORN.get());
                ...
                out.accept(ObjectRegistry.SILO_WOOD.get());
                out.accept(ObjectRegistry.SILO_COPPER.get());
                out.accept(ObjectRegistry.BARREL_MAIN.get());
                out.accept(ObjectRegistry.ROPE.get());
                out.accept(ObjectRegistry.BEER_MUG.get());
                ...
                out.accept(ObjectRegistry.BEER_STANDARD.get());
            })
            .build());
